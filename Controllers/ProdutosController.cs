    ...
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Produtos != null ? 
                          ...
                          Problem("Entity set 'DbContexto.Produtos'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,UrlImagem,Valor,Descricao")] ProdutoModel produtoModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,UrlImagem,Valor,Descricao")] ProdutoModel produtoModel)
        {
